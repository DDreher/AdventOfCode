...
def solve_part1(in_data):
    ...
    for card_data in in_data:
        # print(card_data)
        winning_numbers, my_numbers = card_data.split(' | ')
        winning_numbers = [int(n) for n in winning_numbers[len("Card   1:")::].split(" ") if n != '']
        ...
        card_points = int(math.pow(2, matches - 1))

        # print(f"Matches: {matches}, Points: {card_points}")
...
def solve_part2(in_data):
    ...
    for i, card_data in enumerate(in_data):
        winning_numbers, my_numbers = card_data.split(' | ')
        winning_numbers = [int(n) for n in winning_numbers[len("Card   1:")::].split(" ") if n != '']
        my_numbers = [int(n) for n in my_numbers.split(" ") if n != '']
